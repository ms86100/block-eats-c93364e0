...
const STAGE_CONFIG: Record<string, { label: string; color: string }> = {
  foundation: { label: 'Foundation', color: 'bg-amber-100 text-amber-800 dark:bg-amber-900/30 dark:text-amber-300' },
  structure: { label: 'Structure', color: 'bg-blue-100 text-blue-800 dark:bg-blue-900/30 dark:text-blue-300' },
  mep: { label: 'MEP Works', color: 'bg-purple-100 text-purple-800 dark:bg-purple-900/30 dark:text-purple-300' },
  finishing: { label: 'Finishing', color: 'bg-teal-100 text-teal-800 dark:bg-teal-900/30 dark:text-teal-300' },
  handover: { label: 'Handover', color: 'bg-green-100 text-green-800 dark:bg-green-900/30 dark:text-green-300' },
